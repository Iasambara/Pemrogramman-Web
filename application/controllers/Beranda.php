...
class beranda extends ci_controller{
	...
	function index(){
		...
		$data['title'] = 'Beranda';
		$data['loker'] = $this->db->query("select l.*,i.nama from t_loker l inner join t_industri i on l.id_industri=i.id_industri where l.status='1' order by l.id_loker desc")->result();
