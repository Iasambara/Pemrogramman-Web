			...
			<div class="main-content">
				<div class="row-fluid">
					...
					<div class="row-fluid">
						 <center>
							<div class="row-fluid">
								<h2 class="white" style="margin-top:60px"><b>APLIKASI BURSA KERJA KHUSUS</b></h2>
								<img style="width:110px;" src="<?php echo base_url();?>assets/images/logo1.png" class="user-image" alt="Gambar Pengguna">
								<h3 class="white"><b>SMK NEGERI 1 SINGOSARI</b></h3><BR>
							</div>
						</center>
					</div>		
