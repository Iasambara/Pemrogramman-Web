		...
		<div class="panel panel-default">
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<th width="350" style="vertical-align:middle;">Nama Siswa</th>
					<th width="100" style="vertical-align:middle;">Jenis Kelamin</th>
					<th width="100" style="vertical-align:middle;">Tahun Lulusan</th>
					<?php
					if($status=='3'){
						echo "<th style='vertical-align:middle;'>Perguruan Tinggi</th>";
					}else if(($status=='2') || ($status=='4')){
						echo "<th style='vertical-align:middle;'>Perusahaan</th>";
					}
					?>
				</tr>
				</thead>
				...
				<tr>
                    ...
                    <td style="text-align:left;padding-left:20px"><?php echo strtoupper($row->nama);?></td>
                    <td style="text-align:center"><?php echo $row->jk;?></td>
					<td style="text-align:center"><?php echo $row->tahun_keluar;?></td>
					<?php
					if($status=='3'){
						echo "<td style='text-align:center'>".strtoupper($row->perguruan_tinggi)."</td>";
					}else if(($status=='2') || ($status=='4')){
						echo "<td style='text-align:center'>".strtoupper($row->perusahaan)."</td>";
					}
					?>
                </tr>
                <?php endforeach;?>
