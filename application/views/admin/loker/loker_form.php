...
$tujuan = empty($loker) ? null : explode(',',$loker->tujuan);
$posisi = empty($loker) ? null : $loker->posisi;
...
$keterangan		= empty($loker) ? null : $loker->keterangan;
?>
...
<div class="box box-primary">
                ...
                <div class="form-group">
					...
					<div class="col-sm-8">
                        <select class="form-control js-example-basic-single" name="id_industri" data-bv-trigger="blur">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
                        <input class="form-control" type="text" name="posisi" value="<?php echo $posisi ?>" data-bv-trigger="blur" required>
						<div id="pesan_komentar"><strong class="text-danger">*</strong> Tiap posisi pisahkan tanda <b>koma</b>. contoh : <i>Kasir,Accounting,Teknisi</i></div>
					</div>
                </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<label><input type="checkbox" name="tujuan[]" value="Alumni SMKN 1 Singosari" <?php if (! is_null($tujuan)) { if (in_array("Alumni SMKN 1 Singosari", $tujuan)) echo "checked";}?> >&nbsp;&nbsp;Alumni SMKN 1 Singosari</label><br>
						<label><input type="checkbox" name="tujuan[]" value="SMK Umum" <?php if (! is_null($tujuan)) {if (in_array("SMK Umum", $tujuan)) echo "checked";}?> >&nbsp;&nbsp;SMK Umum</label><br>
						<label><input type="checkbox" name="tujuan[]" value="SMA/Sederajat" <?php if (! is_null($tujuan)) {if (in_array("SMA/Sederajat", $tujuan)) echo "checked";}?> >&nbsp;&nbsp;SMA/Sederajat</label><br>
				...
				<div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Lokasi penempatan</label>									
					<div class="col-sm-8">
                        <select class="form-control" name="id_prov" data-bv-trigger="blur">
							<option value="">Seluruh area kerja industri</option>
                            <?php 
									foreach($prov as $row):
				...
				<div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Keterangan/Alasan Loker Ditutup</label>									
					<div class="col-sm-8">
                       <textarea class="form-control" name="keterangan"  data-bv-trigger="blur" rows=10><?=$keterangan;?></textarea>
                    </div>
                </div>	
