...
<aside class="main-sidebar">
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
				...
				<ul class="treeview-menu">
					...
					<li class="<?php echo ($this->uri->segment(2) == 'berita') ? 'active' : ''; ?>">
						<a href="<?php echo site_url('admin/berita'); ?>">
							<i class="fa fa-circle-o <?php echo ($this->uri->segment(2) == 'berita') ? 'text-aqua' : ''; ?>"></i> Info BKK
						</a>
					</li>
			...
			<li class="treeview <?php echo ($this->uri->segment(2) == 'grafik') ? 'active' : ''; ?>">
				<a href="#">
				...
				<ul class="treeview-menu">
					<li class="<?php echo ($this->uri->segment(2) == 'grafik' and $this->uri->segment(3) == 'grafik_lulusan_pertahun') ? 'active' : ''; ?>">
						<a href="<?php echo site_url('admin/grafik/grafik_lulusan_pertahun'); ?>">
						<i class="fa fa-circle-o <?php echo ($this->uri->segment(2) == 'grafik' and $this->uri->segment(3) == 'grafik_lulusan_pertahun') ? 'text-aqua' : ''; ?>"></i> Grafik Lulusan Pertahun
						</a>
					</li>

					<li class="<?php echo ($this->uri->segment(2) == 'grafik' and $this->uri->segment(3) == 'grafik_keterserapan') ? 'active' : ''; ?>">
						<a href="<?php echo site_url('admin/grafik/grafik_keterserapan'); ?>">
						<i class="fa fa-circle-o <?php echo ($this->uri->segment(2) == 'grafik' and $this->uri->segment(3) == 'grafik_keterserapan') ? 'text-aqua' : ''; ?>"></i> Grafik Keterserapan Lulusan
						</a>
					</li>
				</ul>
			</li>
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="<?php echo ($this->uri->segment(3) == 'jadwal_pribadi' ) ? 'active' : ''; ?>">
				<a href="<?php echo site_url('admin/pelamar/jadwal_pribadi/'.$this->session->userdata('username')); ?>">
					<i class="glyphicon glyphicon-copy <?php echo ($this->uri->segment(3) == 'jadwal_pribadi') ? 'text-aqua' : ''; ?>"></i> Jadwal & Konfirmasi Tes
				</a>
			</li>
