		  	...
		  	<table class="table table-striped table-sm">
                <tbody>
					...
					<tr>
                        ...
                        <td>:</td>
                        <td>
							<select class="form-control" name="status" data-bv-trigger="blur" readonly>
								<option value="6" selected>Diterima</option>						   
							</select>
						</td>
					</tr>
					<tr>
                        ...
                        <td>:</td>
                        <td><input class="form-control" type="date" name="tgl_diterima" value="<?php echo $tgl_diterima ?>" data-bv-trigger="blur"></td>
					</tr>
				</tbody>
			</table>
