					...
					<tr>
                        ...
                        <td>
							<select class="form-control" name="status" data-bv-trigger="blur">
								...
								<option value="1" <?php if($status=='1'){echo "selected=selected";} ?>>Diproses</option>
								<option value="2" <?php if($status=='2'){echo "selected=selected";} ?>>Pendaftaran Diterima</option>
								<option value="3" <?php if($status=='3'){echo "selected=selected";} ?>>Berkas dikirim ke industri</option>
								<option value="4" <?php if($status=='4'){echo "selected=selected";} ?>>Lolos administrasi (diundang tes)</option>
								<option value="5" <?php if($status=='5'){echo "selected=selected";} ?>>Lolos Tes</option>
								<option value="6" <?php if($status=='6'){echo "selected=selected";} ?>>Diterima</option>
							</select>
						</td>
					</tr>
				</tbody>
