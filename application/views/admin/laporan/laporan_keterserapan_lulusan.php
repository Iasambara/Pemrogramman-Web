	...
	<?php } else { ?>
		...
		<div class="col-lg-12">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table">
						...
						<tr>
							<td style="text-align:center;"><h3 style="margin-top:10px;margin-bottom:0px">Laporan Keterserapan Lulusan:</h3>
					<?php
					if($status=='3'){
						echo "<h4 style='font-weight:600'>Data Alumni yang Kuliah</h4>";
					}elseif ($status=='2' or $status=='4'){
						echo "<h4 style='font-weight:600'>Data Alumni yang Bekerja</h4>";
					}
					?>
							</td>
						</tr>
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<?php
					if($row->status=='3'){
						echo "<td>$row->perguruan_tinggi</td>";
					}elseif ($row->status=='2' or $row->status=='4'){
