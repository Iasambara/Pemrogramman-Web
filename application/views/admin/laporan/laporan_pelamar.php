		...
		<div class="col-lg-12">
			...
			<div class="panel-heading" style="height:50px;">
					...
					<div class="pull-right form-group">
						...
						<a href="<?php echo base_url();?>index.php/admin/laporan/export_pelamar
						<?php if ($id_loker!=1) echo '/'.$id_loker;?>" class="btn btn-primary btn-sm pull-right" style="margin-right:5px"><i class="glyphicon glyphicon-share"></i> Export</a>
					</div>
			</div>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table">
						...
						<tr>
							<td style="text-align:center;"><h3 style="margin-top:10px;margin-bottom:0px"><?php echo $title;?></h3></td>
						</tr>
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<th width="50" style="vertical-align:middle;">NIK</th>
					<th width="230" style="vertical-align:middle;">Nama Siswa</th>
					<th width="30" style="vertical-align:middle;">Jenis Kelamin</th>
					<th width="30" style="vertical-align:middle;">Tahun Lulusan</th>
					<th width="200" style="vertical-align:middle;">Nama Industri</th>
<!--					<th style="vertical-align:middle;">Lamaran Sebagai</th> -->
					<th style="vertical-align:middle;">Judul Loker</th>
