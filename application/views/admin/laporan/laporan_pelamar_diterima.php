...
<div class="row">
	<div class="col-lg-12">
		<?=form_open('admin/laporan/laporan_pelamar_diterima', array('role'=>'form', 'class'=>'inline'))?>
	...
	<?php } else { ?>
		...
		<div class="col-lg-12">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table">
						...
						<tr>
							<td style="text-align:center;"><h3 style="margin-top:10px;margin-bottom:0px">Laporan Pelamar Diterima</h3></td>
						</tr>
