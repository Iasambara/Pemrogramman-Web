...
<main>
        ...
        <div class="container">
            <div class="section-popular-travel row justify-content-center">
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column" style="background-image: url('images/Kawah1\ \(1\).jpg');">
                        <div class="travel-country">INDONESIA</div>
                        <div class="travel-location">KAWAH IJEN</div>
                        <div class="travel-button mt-auto">
                            <a href="frontend/details.html" class="btn btn-travel-details px-4">
                                View Details
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column" style="background-image: url('images/travel-2.jpg');">
                        <div class="travel-country">INDONESIA</div>
                        <div class="travel-location">BROMO</div>
                        <div class="travel-button mt-auto">
                            <a href="frontend/details_bromo.html" class="btn btn-travel-details px-4">
                                View Details
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column" style="background-image: url('images/travel-3.jpg');">
                        <div class="travel-country">INDONESIA</div>
                        <div class="travel-location">NUSA PENIDA</div>
                        <div class="travel-button mt-auto">
                            <a href="frontend/details_nusa.html" class="btn btn-travel-details px-4">
                                View Details
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column" style="background-image: url('images/Raja\ \(3\).jpg');">
                        <div class="travel-country">INDONESIA</div>
                        <div class="travel-location">RAJA AMPAT</div>
                        <div class="travel-button mt-auto">
                            <a href="frontend/details_raja.html" class="btn btn-travel-details px-4">
                                View Details
                            </a>
                        </div>
                    </div>
    ...
    <section>
        <div class="Bintang">
            <img src="frontend/Images/Element Bintang.png" width="250px">
        </div>
    </section>
        ...
        <div class="container">
            <div class="section-popular-travel row justify-content-center match-height">
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="frontend/images/Testimonial Violet.png" alt="" width="125px" class="mb-4 rounded-circle" />
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="images/Testimonial Mccandles.png" width="125px" alt="" class="mb-4 rounded-circle" />
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content mb-auto">
                            <img src="images/Testimonial Ismail.png" width="125px" alt="" class="mb-4 rounded-circle" />
